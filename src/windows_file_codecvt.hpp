...
//                                                                                    //
//  Warning: partial implementation; even do_in and do_out only partially meet
//  the    // standard library specifications as the "to" buffer must hold the
//  entire result.   //
//                                                                                    //
//------------------------------------------------------------------------------------//
...
class BOOST_SYMBOL_VISIBLE windows_file_codecvt BOOST_FINAL
 ...
 protected:
  ...
  std::codecvt_base::result do_in(std::mbstate_t& state, const char* from,
                                  ...
                                  wchar_t*& to_next) const BOOST_OVERRIDE;
  ...
  std::codecvt_base::result do_unshift(std::mbstate_t&, char* /*from*/,
                                       char* /*to*/,
                                       char*& /*next*/) const BOOST_OVERRIDE {
    return ok;
  }
