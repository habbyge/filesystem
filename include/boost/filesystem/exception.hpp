...
class BOOST_SYMBOL_VISIBLE filesystem_error : public system::system_error {
 ...
 public:
  BOOST_FILESYSTEM_DECL filesystem_error(const char* what_arg,
                                         system::error_code ec);
  BOOST_FILESYSTEM_DECL filesystem_error(std::string const& what_arg,
                                         system::error_code ec);
  BOOST_FILESYSTEM_DECL filesystem_error(const char* what_arg,
  ...
  BOOST_FILESYSTEM_DECL filesystem_error& operator=(
