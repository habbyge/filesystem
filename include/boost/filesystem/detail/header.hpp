...
// 'm_A' : class 'A' needs to have dll-interface to be used by clients of class
// 'B'
...
// 'X': This function or variable may be unsafe. Consider using Y instead. To
...
// Note: clang-cl goes here as well, as it seems to support gcc-style warning
// control pragmas.
